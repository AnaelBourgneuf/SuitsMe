...
<body>
    ...
    <div style="display: flex; flex-direction: column; align-items: center; margin-top: 20px;">
        <form>
            ...
            <div class="form-check">
                <input class="form-check-input position-static" type="radio" name="search" id="Tous" value="Tous" aria-label="Tous"><label for="Tous"> Tous</label>
            </div>
            <div style="display: flex; flex-direction: column; align-items: center;">
                <input class="form-control mr-sm-2" type="search" placeholder="Rechercher" aria-label="Search" style="margin: 2vh;">
